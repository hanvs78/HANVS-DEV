  ...
  return (
    ...
    >
      <Sidebar
        ...
        // ໃຊ້ຮູບພາບ
        image="/assets/1003.jpg"
        breakPoint="md"
        style={{ height: "100%" }}
        // ຖ້າຕ້ອງການໃຊ້ສີພື້ນ ບໍ່ເອົາຮູບ
        ...
        >
          <div style={{ flex: 1, marginBottom: "32px" }}>
            <Menu iconShape="square">
              ...
              >
                {!isCollapsed && (
                  <Box
                    ...
                    ml="15px"
                  >
                    <Typography>SONEPHET APP</Typography>
              ...
              {!isCollapsed && (
                <Box mb="25px">
                  ...
                  <Box textAlign="center">  
                    <Typography sx={{ m: "10px 0 0 0" }}>HANVS</Typography>
              ...
              {/* Table: localhost:3000/admin/viewtable */}
